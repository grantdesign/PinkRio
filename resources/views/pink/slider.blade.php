...
<div id="slider-cycle" class="slider cycle no-responsive slider_cycle group" style="height:485px;">
	<ul class="slider">
		@foreach($sliders as $key => $slider)
			@if($key % 2 == 0)
			<li>
				<div class="slide-holder" style="background:  url({{ asset('storage/'.$slider->img)  }}) no-repeat center center" style="height:483px;">
	...
	<div id="yit-widget-area" class="group">
		<div class="yit-widget-content inner group">
			...
			<div class="yit-widget widget col1_4 one-fourth col widget-last-post group">
				...
				<div>
					<h3><a class="text-color" href="{{ route('articles') }}" title="">Blog news</a></h3>
					<p>Section shortcodes &amp; sticky posts! <a href="{{ route('articles') }}"> | more →</a></p>
				</div>
			</div>
